...
table_2_1979 = as.matrix(table_2_1979 / sum(table_2_1979, na.rm = TRUE))
table_2_1980 = as.matrix(table_2_1980 / sum(table_2_1980, na.rm = TRUE))
table_3_1975 = as.matrix(table_3_1975 / sum(table_3_1975, na.rm = TRUE))
table_3_1978 = as.matrix(table_3_1978 / sum(table_3_1978, na.rm = TRUE))
```
...
results = replicate(500, generate_abc_sample(epsilon = 1.01,
                                              d1 = table_2_1979,
                                              d2 = table_2_1980))
