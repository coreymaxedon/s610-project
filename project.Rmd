...
```{r get suitable epsilon}
# function and analysis to get appropriate epsilon
test_epsilon <- function(d1, d2){
...
x = replicate(1000, test_epsilon(d1 = table_3_1975, d2 = table_3_1978))
epsilon = quantile(x, 0.001)
```
